...
namespace Infrastructure.Azure.IntegrationTests.EventSourcing.EventStoreFixture
{
    ...
    public class given_empty_store : IDisposable
    {
        ...
        public given_empty_store()
        {
            ...
            this.account = Microsoft.WindowsAzure.Storage.CloudStorageAccount.Parse(settings.ConnectionString);
        ...
        public void Dispose()
        {
           ...
           var cloudTable= client.GetTableReference(this.tableName);
